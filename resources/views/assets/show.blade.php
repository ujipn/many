...
<body class="font-sans antialiased">
    ...
    <!-- 全体：施設が出る部分 -->
    <div class="py-8 flex bg-gray-100">
        <!-- 左側部分 -->
                    ...
                    <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                        <div class="p-6 text-gray-900 dark:text-gray-100">
                            ...
                            <form method="POST" action="{{ route('calendars.store', ['asset_id' => $asset->id]) }}">
                                ...
                                <div class="mb-4">
                                    <!-- 予約開始日 -->
                                    <label class="block text-gray-700 dark:text-gray-300 text-sm font-bold mb-2">チェックイン</label>
                                ...
                                <div class="mb-4">
                                    <!-- 予約終了日 -->
                                    <label class="block text-gray-700 dark:text-gray-300 text-sm font-bold mb-2">チェックアウト</label>
                                ...
                                <button type="submit" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline">予約する</button>
                            </form>
                        </div>
                    </div>
                </div>
